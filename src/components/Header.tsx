...
const Header: React.FC = () => {
	...
	return (
		<header className='grid h-20 w-full grid-cols-auto-1fr items-center justify-between gap-4 border-b border-b-neutral-700 bg-neutral-900 px-12 text-neutral-100'>
